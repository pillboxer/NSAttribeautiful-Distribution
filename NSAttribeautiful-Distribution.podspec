...
Pod::Spec.new do |spec|
  ...
  spec.name         = "NSAttribeautiful-Distribution"
  spec.version      = "1.0.0"
  ...
  # Or just: spec.author    = "Henry Cooper"
  # spec.authors            = { "Henry Cooper" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/Henry Cooper"
  ...
  spec.source       = { :git => "https://github.com/pillboxer/NSAttribeautiful-Distribution.git", :tag => "1.0.0" }
  ...
  spec.source_files  = "NSAttribeautiful.xcframework/**/*.{h,m,swift}"
